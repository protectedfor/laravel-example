...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('works/edit/{id}', ['as' => 'works.edit', 'uses' => 'WorksController@edit'])->where('id', '[0-9]+');
    Route::post('works/update/{id}', ['as' => 'works.update', 'uses' => 'WorksController@update'])->where('id', '[0-9]+');
});
